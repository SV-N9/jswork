(function () {
    function PageList(options) {
        ...
        this.prev.onclick = function () {
            boj.page = (obj.page > 1) ? (obj.page - 1) : 1;
            obj.onChange();
        };
    ...
    PageList.prototype.updateStatus = function () {
        this.first.disabled = (this.pae <= 1);
        this.prev.disabled = (this.pae <= 1);
        this.next.disabled = (this.pae >= this.maxPage);
        this.last.disabled = (this.pae >= this.maxPage);
        this.pageNum.innerHTML = this.page;
    };

    function Comment(ojb) {
        this.obj = obj;
    }
